  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-neutral-dark-01 fixed z-50 flex h-auto flex-col px-4 border-t border-neutral-white-01/10",
        ...
        {...props}
      >
        <div className="bg-neutral-white-01/30 mx-auto mt-4 hidden h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
